      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="card p-8 mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed">
            The Land Registry on Blockchain project is revolutionizing the way
            land ownership is managed. Our mission is to create a decentralized,
            secure, and transparent system that eliminates fraud and
            inefficiencies in traditional land registry processes.
          </p>
        </div>
        ...
        <div className="card p-8 mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed">
            By leveraging blockchain technology, we ensure that every
            transaction is immutable, verifiable, and accessible to authorized
            parties. Our vision is to empower individuals and governments with a
            trustworthy platform that protects property rights and simplifies
            land management.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="card p-6">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Once recorded on the blockchain, land ownership records cannot be
              altered or deleted, ensuring permanent proof of ownership.
            </p>
          </div>
          ...
          <div className="card p-6">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Cryptographic security and decentralized validation make it
              virtually impossible to forge or duplicate land records.
            </p>
          </div>
          ...
          <div className="card p-6">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Property ownership can be verified instantly without the need for
              lengthy paper-based processes or intermediaries.
            </p>
          </div>
          ...
          <div className="card p-6">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Access your land records from anywhere in the world with just an
              internet connection and your digital wallet.
            </p>
          </div>
        </div>
